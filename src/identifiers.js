...
export const queueAndReloadEvent = '_powerlet_queue_and_reload';
export const reloadAllUserScripts = '_powerlet_reload_all_user_scripts';
export const pingEvent = '_powerlet_ping';
export const pongEvent = '_powerlet_pong';
